...
export default function Register() {
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      const diseasesString = values.diseases && values.diseases.length > 0 
      ...
      if (!response.ok) {
        const errorMsg = data.error || data.message || data.details || `Registration failed (${response.status})`;
        setError(errorMsg);
          ...
          <div style={formStyle}>
            ...
            >
              ...
              <Form.Item
                ...
                name="diseases"
                >
                <Select placeholder="Введіть інформацію про хвороби (необов'язково)" allowClear mode="multiple">
